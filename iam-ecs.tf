resource "aws_iam_role" "ecs" {
  count = var.is_create_github_oidc && var.is_create_ecs_oicd_role ? 1 : 0
...
/* -------------------------------------------------------------------------- */
resource "aws_iam_role_policy_attachment" "ecs_fulladmin" {
  count = var.is_create_github_oidc && var.is_create_ecs_oicd_role ? 1 : 0
...
resource "aws_iam_role_policy_attachment" "ecs_ecrpoweruser" {
  count = var.is_create_github_oidc && var.is_create_ecs_oicd_role ? 1 : 0
